...
public class SprintsFromCsvImporter extends DataFromCsvImporter<Sprints> {
    ...
    private static final String ACTUAL_CAPACITY_COLUMN_NAME = "ActualCapacity";
    private static final String PLANNED_EFFORT_COLUMN_NAME = "PlannedEffort";
    private static final String PLANNED_CAPACITY_COLUMN_NAME = "PlannedCapacity";
    ...
    protected void addItem(Sprints container) throws ParseException {
        ...
        final Double plannedCapacity = getDouble(PLANNED_CAPACITY_COLUMN_NAME);
        final Double plannedEffort = getDouble(PLANNED_EFFORT_COLUMN_NAME);
