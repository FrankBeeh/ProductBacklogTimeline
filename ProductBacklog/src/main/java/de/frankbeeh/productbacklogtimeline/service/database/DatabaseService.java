...
public class DatabaseService {
    ...
    private static final String CREATE_PBL_TABLE = "CREATE TABLE IF NOT EXISTS PBL (RF_ID TIMESTAMP NOT NULL, PBI_ID CHAR(20) NOT NULL, PBI_HASH CHAR(40) NOT NULL, CONSTRAINT PK_PBI FOREIGN KEY (PBI_ID, PBI_HASH) REFERENCES PBI(PBI_ID, PBI_HASH))";
