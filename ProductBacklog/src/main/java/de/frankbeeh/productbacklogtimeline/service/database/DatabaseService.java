...
public class DatabaseService {
    ...
    private static final String CREATE_RELEASE_FORECAST_TABLE = "CREATE TABLE IF NOT EXISTS RELEASE_FORECAST (ID TIMESTAMP NOT NULL, NAME VARCHAR(100) NOT NULL, CONSTRAINT PK_RF PRIMARY KEY (ID))";
