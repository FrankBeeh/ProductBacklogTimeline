...
public class ProductBacklogItemIdIsEqualTest {
    ...
    public void isMatching() {
        ...
        assertTrue(criteria.isMatching(new ProductBacklogItem("10", null, null, null, null)));
    }

    @Test
    public void isNotMatching() {
        final Criteria criteria = new ProductBacklogItemIdIsEqual("11");
        assertFalse(criteria.isMatching(new ProductBacklogItem("10", null, null, null, null)));
    }
