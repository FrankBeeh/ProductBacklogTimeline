...
public class ComputeEffortForecastByAverageVelocityTest {

    private static final double CAPACITY_FORECAST_1 = 10d;
    private static final double EFFORT_FORECAST_1 = 5d;
    private static final double VELOCITY_FORECAST_1 = EFFORT_FORECAST_1 / CAPACITY_FORECAST_1;

    private static final double CAPACITY_DONE_1 = 6d;
    private static final double EFFORT_DONE_1 = 3d;
    private static final double VELOCITY_DONE_1 = EFFORT_DONE_1 / CAPACITY_DONE_1;

    private static final double EFFORT_FORECAST_2 = 7d;
    private static final double CAPACITY_FORECAST_2 = 11d;
    private static final double VELOCITY_FORECAST_2 = EFFORT_FORECAST_2 / CAPACITY_FORECAST_2;

    private static final double EFFORT_DONE_2 = 8d;
    private static final double CAPACITY_DONE_2 = 13d;
    ...
    private ComputeEffortForecastByAverageVelocity visitor;
    ...
    @Before
    public void setUp() {
        visitor = new ComputeEffortForecastByAverageVelocity();
    }
