...
public class ProductBacklogFromCsvImporterTest {
    ...
    private static final String HEADER = "Key;Summary;Description;Story Points;Status;Sprint;Rank\r\n";
    ...
    public void importMultipleProductBacklogItems() throws Exception {
        final ProductBacklog productBacklog = importer.importData(new StringReader(HEADER + "Id 1;Titel 1;Beschreibung 1;0.5;Done;Sprint 1;9\r\n"
                + "Id 2;Titel 2;Beschreibung 2;1;Todo;Sprint 2;10\r\n"));
        assertEquals(
                Arrays.asList(new ProductBacklogItem("Id 1", "Titel 1", "Beschreibung 1", 0.5, State.Done, "Sprint 1", 9),
    ...
    public void importProductBacklogItemInDifferentRowOrder() throws Exception {
        final ProductBacklog productBacklog = importer.importData(new StringReader("Rank;Sprint;Status;Story Points;Description;Summary;Key\r\n"
                + "10;Sprint 1;Canceled;0.5;Beschreibung 1;Titel 1;Id 1\r\n"));
