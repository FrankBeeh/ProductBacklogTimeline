...
public class ImportProductBacklogUITest extends BaseUITest {
    ...
    private static final TableViewContent PBL_1 = new TableViewContent(new String[][] { { "1", "3.0", "Done", "PBI 1", "Description 1", "3.0", "Sprint 1", "", "", "" },
            { "2", "1.0", "Todo", "PBI 2", "Description 2", "4.0", "Sprint 1", "", "", "" }, { "3", "5.0", "Todo", "PBI 3", "Description 3", "9.0", "", "", "", "" },
            { "4", "8.0", "Todo", "PBI 4", "Description 4", "17.0", "", "", "", "" } });
    ...
    private static final TableViewContent PBL_1_WITH_FORECAST_1 = new TableViewContent(new String[][] {
            ...
            { "2", "1.0", "Todo", "PBI 2", "Description 2", "4.0", "Sprint 1", SPRINT_2, SPRINT_2, SPRINT_2 },
            { "3", "5.0", "Todo", "PBI 3", "Description 3", "9.0", "", SPRINT_3, SPRINT_3, SPRINT_3 }, { "4", "8.0", "Todo", "PBI 4", "Description 4", "17.0", "", SPRINT_5, SPRINT_5, SPRINT_5 } });
    ...
    private static final TableViewContent VELOCITY_FORECAST_1 = new TableViewContent(new String[][] {
            { "Sprint 1", "25.04.2014", "25.04.2014", "4.0", "4.0", "6.0", "3.0", "3.0", "3.0", "3.0", "", "", "", "" },
