...
public class ProductBacklogItemIdIsEqualTest {
    ...
    public void isMatching() {
        ...
        assertTrue(criteria.isMatching(new ProductBacklogItemComparison(new ProductBacklogItem("10", null, null, null, null, null, null, null),null)));
    }

    @Test
    public void isNotMatching() {
        final ReleaseCriteria criteria = new ProductBacklogItemIdIsEqual("11");
        assertFalse(criteria.isMatching(new ProductBacklogItemComparison(new ProductBacklogItem("10", null, null, null, null, null, null, null), null)));
    }
