...
public class VelocityForecastFromCsvImporterTest {
    ...
    public void importMultipleSprints() throws Exception {
        final List<Sprint> expectedSprints = Arrays.asList(
                new Sprint("Sprint 1", FormatUtility.parseLocalDate("01.02.2003"), FormatUtility.parseLocalDate("02.03.2004"), Double.parseDouble("10.5"), Double.parseDouble("3.5"),
                        Double.parseDouble("8.5"), Double.parseDouble("8")),
                new Sprint("Sprint 2", FormatUtility.parseLocalDate("03.04.2005"), FormatUtility.parseLocalDate("04.05.2006"), Double.parseDouble("10"), Double.parseDouble("2"), null, null));
