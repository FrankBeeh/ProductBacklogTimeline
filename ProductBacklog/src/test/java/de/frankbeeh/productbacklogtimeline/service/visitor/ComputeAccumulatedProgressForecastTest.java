...
public class ComputeAccumulatedProgressForecastTest {
    ...
    @Test
    public void visit() {
        final Sprint sprintData1 = createSprintData(EFFORT_DONE_1, PROGRESS_FORECAST_1);
        visitor.visit(sprintData1);
        assertEquals(null, sprintData1.getAccumulatedProgressForecastBasedOnHistory(HISTORY_NAME));

        final Sprint sprintData2 = createSprintData(null, PROGRESS_FORECAST_2);
        ...
        final Sprint sprintData3 = createSprintData(null, PROGRESS_FORECAST_3);
        ...
        final Sprint sprintData4 = createSprintData(null, null);
        visitor.visit(sprintData4);
        assertEquals(null, sprintData4.getAccumulatedProgressForecastBasedOnHistory(HISTORY_NAME));

        final Sprint sprintData5 = createSprintData(null, PROGRESS_FORECAST_5);
    ...
    private Sprint createSprintData(Double accumulatedEffortDone, Double progressForecast) {
