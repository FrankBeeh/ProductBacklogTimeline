...
public class ProductBacklogFromCsvImporterTest {
    ...
    private static final String HEADER = "Key;Summary;Description;Story Points;Resolution;Sprint;Rank;Fix Version/s\r\n";
    ...
    public void importMultipleProductBacklogItems() throws Exception {
        final ProductBacklog productBacklog = importer.importData(new StringReader(HEADER + "Id 1;Titel 1;Beschreibung 1;0.5;Fixed;Sprint 1;09;Version 1\r\n"
                + "Id 2;Titel 2;Beschreibung 2;1;Unresolved;Sprint 2;10;Version 2\r\n"));
        assertEquals(
                Arrays.asList(new ProductBacklogItem("Id 1", "Titel 1", "Beschreibung 1", 0.5, State.Done, "Sprint 1", "09", "Version 1"),
                        new ProductBacklogItem("Id 2", "Titel 2", "Beschreibung 2", 1d, State.Todo, "Sprint 2", "10", "Version 2")).toString(), productBacklog.getItems().toString());
    }

    @Test
    public void importProductBacklogItemInDifferentRowOrder() throws Exception {
        final ProductBacklog productBacklog = importer.importData(new StringReader("Rank;Sprint;Fix Version/s;Resolution;Story Points;Description;Summary;Key\r\n"
                + "10;Sprint 1;Version 1;Won't Fix;0.5;Beschreibung 1;Titel 1;Id 1\r\n"));
        assertEquals(Arrays.asList(new ProductBacklogItem("Id 1", "Titel 1", "Beschreibung 1", 0.5, State.Canceled, "Sprint 1", "10", "Version 1")).toString(), productBacklog.getItems().toString());
    }
