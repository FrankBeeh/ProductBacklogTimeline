...
public class ProductBacklogItemComparisonTest {
    ...
    private ProductBacklogItemComparison productBacklogComparisonItem;
    ...
    public void getComparedTitle_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithTitle(null)).getComparedTitle());
    }

    @Test
    public void getComparedTitle_noReference() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithTitle(STRING_VALUE_1)).getComparedTitle());
    }

    @Test
    public void getComparedTitle_referenceNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithTitle(STRING_VALUE_1), null).getComparedTitle());
    }

    @Test
    public void getComparedTitle_referenceValueNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithTitle(STRING_VALUE_1), createProductBacklogItemWithTitle(null)).getComparedTitle());
    }

    @Test
    public void getComparedTitle_equal() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithTitle(STRING_VALUE_1), createProductBacklogItemWithTitle(STRING_VALUE_1)).getComparedTitle());
    }

    @Test
    public void getComparedTitle_notEqual() throws Exception {
        assertEquals(STRING_VALUE_1 + "\n(" + STRING_VALUE_2 + ")", new ProductBacklogItemComparison(createProductBacklogItemWithTitle(STRING_VALUE_1),
    ...
    public void getComparedDescription_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithDescription(null)).getComparedDescription());
    }

    @Test
    public void getComparedDescription_noReference() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithDescription(STRING_VALUE_1)).getComparedDescription());
    }

    @Test
    public void getComparedDescription_referenceNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithDescription(STRING_VALUE_1), null).getComparedDescription());
    }

    @Test
    public void getComparedDescription_referenceValueNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithDescription(STRING_VALUE_1), createProductBacklogItemWithDescription(null)).getComparedDescription());
    }

    @Test
    public void getComparedDescription_equal() throws Exception {
        assertEquals(STRING_VALUE_1,
                new ProductBacklogItemComparison(createProductBacklogItemWithDescription(STRING_VALUE_1), createProductBacklogItemWithDescription(STRING_VALUE_1)).getComparedDescription());
    }

    @Test
    public void getComparedDescription_notEqual() throws Exception {
        assertEquals(STRING_VALUE_1 + "\n(" + STRING_VALUE_2 + ")", new ProductBacklogItemComparison(createProductBacklogItemWithDescription(STRING_VALUE_1),
    ...
    public void getComparedSprint_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithSprint(null)).getComparedJiraSprint());
    }

    @Test
    public void getComparedSprint_noReference() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithSprint(STRING_VALUE_1)).getComparedJiraSprint());
    }

    @Test
    public void getComparedSprint_referenceNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithSprint(STRING_VALUE_1), null).getComparedJiraSprint());
    }

    @Test
    public void getComparedSprint_referenceValueNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithSprint(STRING_VALUE_1), createProductBacklogItemWithSprint(null)).getComparedJiraSprint());
    }

    @Test
    public void getComparedSprint_equal() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithSprint(STRING_VALUE_1), createProductBacklogItemWithSprint(STRING_VALUE_1)).getComparedJiraSprint());
    }

    @Test
    public void getComparedSprint_notEqual() throws Exception {
        assertEquals(STRING_VALUE_1 + "\n(" + STRING_VALUE_2 + ")", new ProductBacklogItemComparison(createProductBacklogItemWithSprint(STRING_VALUE_1),
    ...
    public void getComparedPlannedRelease_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(null)).getComparedPlannedRelease());
    }

    @Test
    public void getComparedPlannedRelease_noReference() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(STRING_VALUE_1)).getComparedPlannedRelease());
    }

    @Test
    public void getComparedPlannedRelease_referenceNull() throws Exception {
        assertEquals(STRING_VALUE_1, new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(STRING_VALUE_1), null).getComparedPlannedRelease());
    }

    @Test
    public void getComparedPlannedRelease_referenceValueNull() throws Exception {
        assertEquals(STRING_VALUE_1,
                new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(STRING_VALUE_1), createProductBacklogItemWithPlannedRelease(null)).getComparedPlannedRelease());
    }

    @Test
    public void getComparedPlannedRelease_equal() throws Exception {
        assertEquals(STRING_VALUE_1,
                new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(STRING_VALUE_1), createProductBacklogItemWithPlannedRelease(STRING_VALUE_1)).getComparedPlannedRelease());
    }

    @Test
    public void getComparedPlannedRelease_notEqual() throws Exception {
        assertEquals(STRING_VALUE_1 + "\n(" + STRING_VALUE_2 + ")", new ProductBacklogItemComparison(createProductBacklogItemWithPlannedRelease(STRING_VALUE_1),
    ...
    public void getComparedCompletionForecast_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithCompletionForecast(null), null).getComparedCompletionForecast(VELOCITY_FORECAST));
    }
    ...
    public void getComparedCompletionForecast_notEqual() throws Exception {
        assertEquals("Sprint 1\n(Sprint 2)\n01.02.2003\n(-14d)", new ProductBacklogItemComparison(createProductBacklogItemWithCompletionForecast(sprint1),
    ...
    public void getComparedState_valueNull() throws Exception {
        assertNull(new ProductBacklogItemComparison(createProductBacklogItemWithState(null)).getComparedState());
    }

    @Test
    public void getComparedState_noReference() throws Exception {
        assertEquals(State.Todo.toString(), new ProductBacklogItemComparison(createProductBacklogItemWithState(State.Todo)).getComparedState());
    }

    @Test
    public void getComparedState_referenceNull() throws Exception {
        assertEquals(State.Todo.toString(), new ProductBacklogItemComparison(createProductBacklogItemWithState(State.Todo), null).getComparedState());
    }

    @Test
    public void getComparedState_referenceValueNull() throws Exception {
        assertEquals(State.Todo.toString(), new ProductBacklogItemComparison(createProductBacklogItemWithState(State.Todo), createProductBacklogItemWithState(null)).getComparedState());
    }

    @Test
    public void getComparedState_equal() throws Exception {
        assertEquals(State.Todo.toString(), new ProductBacklogItemComparison(createProductBacklogItemWithState(State.Todo), createProductBacklogItemWithState(State.Todo)).getComparedState());
    }

    @Test
    public void getComparedState_notEqual() throws Exception {
        assertEquals(State.Todo.toString() + "\n(" + State.Done.toString() + ")", new ProductBacklogItemComparison(createProductBacklogItemWithState(State.Todo),
    ...
    public void getComparedEstimate_valueNull() throws Exception {
        ...
        assertNull(new ProductBacklogItemComparison(productBacklogItem).getComparedEstimate());
    }

    @Test
    public void getComparedEstimate_noReference() throws Exception {
        productBacklogItem.setEstimate(2d);
        assertEquals("2.0", new ProductBacklogItemComparison(productBacklogItem).getComparedEstimate());
    }
    ...
    public void getComparedAccumulatedEstimate_valueNull() throws Exception {
        ...
        assertNull(new ProductBacklogItemComparison(productBacklogItem).getComparedAccumulatedEstimate());
    }

    @Test
    public void getComparedAccumulatedEstimate_noReference() throws Exception {
        productBacklogItem.setAccumulatedEstimate(2d);
        assertEquals("2.0", new ProductBacklogItemComparison(productBacklogItem).getComparedAccumulatedEstimate());
    }
    ...
    public void getComparedProductBacklogRank_noReference() throws Exception {
        ...
        assertEquals("2", new ProductBacklogItemComparison(productBacklogItem).getComparedProductBacklogRank());
    }

    @Test
    public void getComparedProductBacklogRank_referenceNull() throws Exception {
        productBacklogItem.setProductBacklogRank(2);
        assertEquals("     2\n(NEW)", new ProductBacklogItemComparison(productBacklogItem, null).getComparedProductBacklogRank());
    }
    ...
    public void setUp() throws Exception {
        ...
        productBacklogComparisonItem = new ProductBacklogItemComparison(productBacklogItem, referenceProductBacklogItem);
